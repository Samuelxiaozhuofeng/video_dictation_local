    ...
    <>
      ...
      <aside className="fixed inset-y-0 right-0 z-50 w-full sm:w-[360px] bg-page border-l border-line shadow-lift flex flex-col slide-in" aria-label={t('common.savedLines')}>
        <div className="h-14 px-5 flex items-center justify-between border-b border-line">
          <span className="text-lg font-semibold inline-flex items-center gap-2"><Bookmark size={18} /> {t('common.savedLines')}</span>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-2">
          {savedItems.length === 0 ? (
            ...
            <div key={item.id} className="py-4 border-b border-line last:border-b-0">
              <p className="font-serif text-[17px] leading-relaxed">“{item.text}”</p>
