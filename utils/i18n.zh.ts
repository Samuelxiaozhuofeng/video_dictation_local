...
export const zh: Record<keyof typeof en, string> = {
  ...
  'import.cloudKey': 'Groq 密钥没填或不对。打开 设置 → 转录 重新填，再点重试',
  'import.cloudQuota': 'Groq 免费额度暂时用完了（{detail}）。过一会儿再点重试，或到 设置 → 转录 改用本机',
  'import.cloudNetwork': '连不上 Groq（{detail}）。检查网络后点重试，国内可能需要翻墙',
  'import.cloudDenied': 'Groq 拒绝了请求（{detail}）。可能是所在地区不支持，换个网络后点重试',
  'import.cloudTooLarge': '声音文件太大，Groq 不收。到 设置 → 转录 改用本机',
  'import.cloudEmpty': 'Groq 没听出任何话，视频里可能没有人声',
  ...
  'add.cloudNote': '用 Groq 云端转录：声音会上传到 Groq，不用下载组件。',
  'add.cloudNoKey': '你选了云端转录，但还没填 Groq 密钥。打开 设置 → 转录 填上再来。',
