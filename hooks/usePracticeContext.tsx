...
export interface PracticeContextActions {
  ...
  onTogglePlay: () => void;
  onReplayCurrent: (autoAdvanceAfter?: boolean, fromRatio?: number, toRatio?: number) => void;
  ...
  onAddToAnki: () => void;
  onWordToAnki: (word: string, definition: string, example?: string) => void | Promise<void>;
  onNextSection: () => void;
