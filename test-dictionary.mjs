...
const { detectLang, parseYoudao, pickEudicTerms, senseToAnki, senseList, getDictChoice, saveDictChoice } = await import(out);
...
assert.deepEqual(getDictChoice(), { en: 'youdao', es: 'eudic', fr: 'eudic', de: 'eudic' });
...
assert.deepEqual(getDictChoice(), { en: 'cambridge', es: 'eudic', fr: 'youdao', de: 'eudic' });
